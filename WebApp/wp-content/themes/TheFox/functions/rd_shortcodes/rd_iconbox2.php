...
if($change_hover !== ''){
	...
	$output .='<style>#rand_'.$box_id.':hover {background:'.$hover_boxbg_color.' !important; border:1px solid '.$hover_boxb_color.' !important; color:'.$hover_text_color.'!important;}#rand_'.$box_id.':hover .icon_circle{background:'.$hover_t_color.' !important; border:4px solid '.$hover_i_color.'!important;}#rand_'.$box_id.':hover .icon_circle i{color:'.$hover_i_color.' !important;}#rand_'.$box_id.':hover h3{color:'.$hover_t_color.' !important;}#rand_'.$box_id.':hover .box_btn{ background:'.$hover_button_color.' !important; color:'.$hover_button_t_color.'!important; border:1px solid '.$hover_button_b_color.' !important;  }#rand_'.$box_id.':hover p{ color:'.$hover_text_color.';}</style> ';
	
}


	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2_alt '.$animation.'" style="background:'.$boxbg_color.'; border:1px solid '.$boxb_color.'; padding:65px 30px 50px 30px;"><div class="icon_circle" style="background-color:'.$i_color.';"><i class="'.$icon.'" ></i></div><h3 style="color:'.$t_color.';">'. do_shortcode($title) .'</h3><p style="padding:2px 0 10px 0">'. do_shortcode($content) .'</p><a class="box_btn" style="background-color:'.$button_color.'; color:'.$button_t_color.'; border:1px solid '.$button_b_color.';" href="'.$link.'" '.$target.'>'.$button_text.'</a></div>';
	if($link !== ''){$output .= '</a>'; }
...
if($change_hover !== ''){
	...
	$output .='<style>#rand_'.$box_id.':hover {background:'.$hover_boxbg_color.' !important; border:1px solid '.$hover_boxb_color.' !important; color:'.$hover_text_color.'!important; border-bottom:3px solid '.$hover_i_color.' !important;}#rand_'.$box_id.':hover .icon_circle{background:'.$hover_i_color.' !important; border:1px solid '.$hover_boxb_color.'!important;}#rand_'.$box_id.':hover .simple_sub_circle{background:#2d3e50 !important;}#rand_'.$box_id.':hover h3{color:'.$hover_t_color.' !important;}#rand_'.$box_id.':hover .box_btn{color:'.$hover_button_t_color.'!important; }#rand_'.$box_id.':hover p{ color:'.$hover_text_color.';}</style> ';
	
}


	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2_simple '.$animation.'" style="background:'.$boxbg_color.'; border:1px solid '.$boxb_color.';"><div class="icon_circle" style="background-color:'.$boxbg_color.'; border:1px solid '.$boxb_color.';"><div class="simple_sub_circle" style="background:'.$i_color.';"></div><i class="'.$icon.'" ></i></div><h3 style="color:'.$t_color.';">'. do_shortcode($title) .'</h3><p style="padding:10px 0 10px 0">'. do_shortcode($content) .'</p><a class="box_btn" style="color:'.$button_t_color.'; background:none!important; border:none!important;" href="'.$link.'" '.$target.'>'.$button_text.'</a></div>';
	if($link !== ''){$output .= '</a>'; }
...
if($button_text == ''){
	...
	$output .='';
	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2 '.$animation.'" style="background:'.$boxbg_color.'; border:1px solid '.$boxb_color.';"><div class="icon_circle" style="border:1px solid '.$i_color.';"><div class="sub_circle"></div><i class="'.$icon.'" style="color:'.$i_color.';"></i></div><h3 style="color:'.$t_color.';" >'. do_shortcode($title) .'</h3><p style="color:'.$content_color.';" >'. do_shortcode($content) .'</p></div>';
	if($link !== ''){$output .= '</a>'; }
   $output .= $ret;
...
if($change_hover !== ''){
	...
	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
    $output .= '<div id="rand_'.$box_id.'" class="icon_box2 '.$animation.'" style="padding: 43px 30px 27px 30px; background:'.$boxbg_color.'; border:1px solid '.$boxb_color.';"><div class="icon_circle" style="border:1px solid '.$i_color.';"><div class="sub_circle"></div><i class="'.$icon.'" style="color:'.$i_color.';"></i></div><h3 style="color:'.$t_color.';">'. do_shortcode($title) .'</h3><p style="color:'.$content_color.';" >'. do_shortcode($content) .'</p><a class="box_btn" style="color:'.$button_t_color.'; " href="'.$link.'" '.$target.'>'.$button_text.'</a></div>';
	if($link !== ''){$output .= '</a>'; }
...
if($button_text == ''){
	...
	$output .='';
	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2_trending '.$animation.'" style="background:'.$boxbg_color.'; border:1px solid '.$boxb_color.';"><div class="icon_circle"><i class="'.$icon.'" style="color:'.$i_color.';"></i></div><h3 style="color:'.$t_color.';" >'. do_shortcode($title) .'</h3><p style="color:'.$content_color.';" >'. do_shortcode($content) .'</p></div>';
	if($link !== ''){$output .= '</a>'; }
   $output .= $ret;
...
if($change_hover !== ''){
	...
	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
    $output .= '<div id="rand_'.$box_id.'" class="icon_box2_trending '.$animation.'" style="padding: 43px 30px 27px 30px; background:'.$boxbg_color.'; border:1px solid '.$boxb_color.';"><div class="icon_circle"><i class="'.$icon.'" style="color:'.$i_color.';"></i></div><h3 style="color:'.$t_color.';">'. do_shortcode($title) .'</h3><p style="color:'.$content_color.';" >'. do_shortcode($content) .'</p><a class="box_btn" style="color:'.$button_t_color.'; " href="'.$link.'" '.$target.'>'.$button_text.'</a></div>';
	if($link !== ''){$output .= '</a>'; }
...
if($change_hover !== ''){
	...
	$output .='<style>#rand_'.$box_id.':hover .icon_circle{background:'.$i_color.' !important;}#rand_'.$box_id.':hover .icon_circle i{color:#fff !important;}#rand_'.$box_id.':hover .icon_circle i:before{background:'.$hover_i_color.';}#rand_'.$box_id.':hover h3{color:'.$hover_t_color.' !important;}#rand_'.$box_id.':hover p{color:'.$hover_text_color.' !important;}#rand_'.$box_id.':hover p{ color:'.$hover_text_color.';}</style> ';
	
}
	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2_bc '.$animation.'"><div class="icon_circle"><i class="'.$icon.'" ></i></div><h3 style="color:'.$t_color.';" >'. do_shortcode($title) .'</h3><p style="color:'.$content_color.';" >'. do_shortcode($content) .'</p></div>';
	if($link !== ''){$output .= '</a>'; }
...
if($change_hover !== ''){
	...
	$output .='<style>#rand_'.$box_id.':hover .icon_circle{background:'.$i_color.' !important;}#rand_'.$box_id.':hover .icon_circle i{color:#fff !important;}#rand_'.$box_id.':hover .icon_circle i:before{background:'.$hover_i_color.';}#rand_'.$box_id.':hover h3{color:'.$hover_t_color.' !important;}#rand_'.$box_id.':hover p{color:'.$hover_text_color.' !important;}#rand_'.$box_id.':hover .box_btn{ background:'.$hover_button_color.' !important; color:'.$hover_button_t_color.'!important; border:1px solid '.$hover_button_b_color.' !important;  }#rand_'.$box_id.':hover p{ color:'.$hover_text_color.';}</style> ';
	
}


	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2_bc '.$animation.'" ><div class="icon_circle"><i class="'.$icon.'" ></i></div><h3 style="color:'.$t_color.';">'. do_shortcode($title) .'</h3><p style="padding:2px 0 10px 0">'. do_shortcode($content) .'</p><a class="box_btn" style="background-color:'.$button_color.'; color:'.$button_t_color.'; border:1px solid '.$button_b_color.';" href="'.$link.'" '.$target.'>'.$button_text.'</a></div>';
	if($link !== ''){$output .= '</a>'; }
...
if($change_hover !== ''){
		...
		$output .='<style>#rand_'.$box_id.':hover h3{color:'.$hover_t_color.' !important;}#rand_'.$box_id.':hover p{color:'.$hover_text_color.' !important;}#rand_'.$box_id.':hover .icon_sub_ctn,#rand_'.$box_id.':hover .icon_sub_ctn:before,#rand_'.$box_id.':hover .icon_sub_ctn:after{background:'.$hover_i_color.'; }#rand_'.$box_id.':hover p{ color:'.$hover_text_color.';}</style> ';
...
if ($button_color !== 'rgba(0,0,0,0)' || $button_b_color !== 'rgba(0,0,0,0)' ){
	...
	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2_hex '.$animation.'"><div class="icon_circle"><div class="icon_sub_ctn"><i class="'.$icon.'" ></i></div></div><h3 style="color:'.$t_color.';" >'. do_shortcode($title) .'</h3><p style="color:'.$content_color.';" >'. do_shortcode($content) .'</p>';
...
if ($button_color !== 'rgba(0,0,0,0)' || $button_b_color !== 'rgba(0,0,0,0)' ){
	...
	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2_hexbox '.$animation.'"><div class="icon_circle"><div class="icon_sub_ctn"><i class="'.$icon.'" ></i></div></div><h3 style="color:'.$t_color.';" >'. do_shortcode($title) .'</h3><p style="color:'.$content_color.';" >'. do_shortcode($content) .'</p>';
...
if ($button_color !== 'rgba(0,0,0,0)' || $button_b_color !== 'rgba(0,0,0,0)' ){
	...
	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2_br '.$animation.'"><div class="icon_circle"><i class="'.$icon.'" ></i></div><h3 style="color:'.$t_color.';" >'. do_shortcode($title) .'</h3><p style="color:'.$content_color.';" >'. do_shortcode($content) .'</p>';
...
if ($button_color !== 'rgba(0,0,0,0)' || $button_b_color !== 'rgba(0,0,0,0)' ){
	...
	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2_left_b '.$animation.'"><div class="icon_circle"><i class="'.$icon.'" ></i></div><h3 style="color:'.$t_color.';" >'. do_shortcode($title) .'</h3><p style="color:'.$content_color.';" >'. do_shortcode($content) .'</p>';
...
if($change_hover !== ''){
		...
		$output .='<style>#rand_'.$box_id.':hover h3{color:'.$hover_t_color.' !important;}#rand_'.$box_id.':hover p{color:'.$hover_text_color.' !important;}#rand_'.$box_id.':hover .icon_sub_ctn{background:'.$hover_i_color.'; }#rand_'.$box_id.':hover p{ color:'.$hover_text_color.';}</style> ';
...
if ($button_color !== 'rgba(0,0,0,0)' || $button_b_color !== 'rgba(0,0,0,0)' ){
	...
	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2_big_cg '.$animation.'"><div class="icon_circle"><div class="icon_sub_ctn"><i class="'.$icon.'" ></i></div></div><h3 style="color:'.$t_color.';" >'. do_shortcode($title) .'</h3><p style="color:'.$content_color.';" >'. do_shortcode($content) .'</p>';
...
if($change_hover !== ''){
		...
		$output .='<style>#rand_'.$box_id.':hover h3{color:'.$hover_t_color.' !important;}#rand_'.$box_id.':hover p{color:'.$hover_text_color.' !important;}#rand_'.$box_id.':hover h3:after{background:'.$hover_boxb_color.';}#rand_'.$box_id.':hover .icon_circle{color:#fff!important;}#rand_'.$box_id.':hover .icon_circle{ background:'.$hover_i_color.';}#rand_'.$box_id.':hover p{ color:'.$hover_text_color.';}</style> ';
...
if ($button_color !== 'rgba(0,0,0,0)' || $button_b_color !== 'rgba(0,0,0,0)' ){
	...
	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2_big_cg_trending '.$animation.'"><div class="icon_circle"><i class="'.$icon.'" ></i></div><h4 style="color:'.$st_color.';" >'. do_shortcode($subtitle) .'</h4><h3 style="color:'.$t_color.';" >'. do_shortcode($title) .'</h3><p style="color:'.$content_color.';" >'. do_shortcode($content) .'</p>';
...
if($change_hover !== ''){
		...
		$output .='<style>#rand_'.$box_id.':hover,#rand_'.$box_id.':hover .icon_circle,#rand_'.$box_id.':hover .icon_sub_ctn{background:'.$hover_boxbg_color.' ; border:1px solid '.$hover_boxb_color.'; }#rand_'.$box_id.':hover h3{color:'.$hover_t_color.' !important;}#rand_'.$box_id.':hover p{color:'.$hover_text_color.' !important;}#rand_'.$box_id.':hover .icon_sub_ctn{background:'.$hover_i_color.'; color:#fff;}#rand_'.$box_id.':hover p{ color:'.$hover_text_color.';}</style> ';
...
if ($button_color !== 'rgba(0,0,0,0)' || $button_b_color !== 'rgba(0,0,0,0)' ){
	...
	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2_st '.$animation.'"><div class="icon_circle"><div class="icon_sub_ctn"><i class="'.$icon.'" ></i></div></div><h3 style="color:'.$t_color.';" >'. do_shortcode($title) .'</h3><p style="color:'.$content_color.';" >'. do_shortcode($content) .'</p>';
...
if($change_hover !== ''){
		...
		$output .='<style>#rand_'.$box_id.':hover h3{color:'.$hover_t_color.' !important;}#rand_'.$box_id.':hover p{color:'.$hover_text_color.' !important;}#rand_'.$box_id.':hover .icon_circle{background-color:'.$hover_i_color.'; color:#fff;}#rand_'.$box_id.':hover p{ color:'.$hover_text_color.';}</style> ';
...
if ($button_color !== 'rgba(0,0,0,0)' || $button_b_color !== 'rgba(0,0,0,0)' ){
	...
	if($link !== ''){$output .= '<a href="'.$link.'" target="'.$target.'" >';}
   $output .= '<div id="rand_'.$box_id.'" class="icon_box2_sc '.$animation.'"><div class="icon_circle"><i class="'.$icon.'" ></i></div><h3 style="color:'.$t_color.';" >'. do_shortcode($title) .'</h3><p style="color:'.$content_color.';" >'. do_shortcode($content) .'</p>';
