...
if( $post_format == 'quote' ){	
 ...
 ?>
  <div class="post_ctn"> 
    ...
    <div class="entry">
          <?php 	if ( $post_format == 'audio' ){ echo !empty( $content ) ? $content : '';}elseif($more_option == 'cutted'){ rd_custom_excerpt('rd_port_long_excerpt','rd_related_more'); }else{ the_content(__('Read more', 'thefoxwp'));}?>
    </div>
