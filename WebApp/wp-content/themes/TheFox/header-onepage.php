...
<!-- header -->
<header  class="<?php if ($nav_type !== 'nav_type_15' && $nav_type !== 'nav_type_16' && $nav_type !== 'nav_type_17' && $nav_type !== 'nav_type_18' && $nav_type !== 'nav_type_19' && $nav_type !== 'nav_type_19_f' ){echo 'header_shadow sticky_header '.$nav_type.''; }elseif($nav_type == 'nav_type_19'){ echo 'fixed_header_left';}elseif($nav_type == 'nav_type_19_f'){ echo 'fixed_header_left absolute_navigation';}else{ echo esc_attr($nav_type);} if($rd_data['rd_header_shrink'] !== 'no'){ echo ' header_to_shrink'; }?> clearfix" >
<div class="wrapper">
<!-- logo -->
<?php 
