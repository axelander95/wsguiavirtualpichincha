...
<div class="page_title_ctn boxed_t_left">
  <div class="wrapper">
    <h1>
      <?php if($rd_data["rd_blog_title"] == ''){echo __('Blog', 'thefoxwp');} else { echo $rd_data["rd_blog_title"];} ?> </h1>
...
<div class="section def_section">
  ...
  <?php if ($rd_data["rd_blog_sidebar"] !== 'no' ) { 
 ?>
...
if( $post_format == 'quote' ){	
 ...
 ?>
  <div class="post_ctn"> 
    ...
    <!-- .entry -->    
    <div class="entry">
      <?php 	if ( $post_format == 'audio' ){ echo !empty( $content ) ? $content : '';}else{ rd_custom_excerpt('rd_port_long_excerpt','rd_related_more'); }?>
    </div>   
    <!-- .entry END --> 
     </div>
	</div>
