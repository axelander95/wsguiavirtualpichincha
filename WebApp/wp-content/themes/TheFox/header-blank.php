...
?>
<div id="jpreOverlay" class="<?php echo esc_attr($rd_data['rd_loader_style']); ?>"><div id="preloader_3"></div><div id="jpreLoader"><div id="jpreBar"></div></div><div id="jprePercentage">0%</div><img class="pre_dummy_img" src="<?php echo get_template_directory_uri(); ?>/images/loader.gif"/></div>
...
</div><img class="pre_dummy_img" src="<?php echo get_template_directory_uri(); ?>/images/loader.gif"/></div>
