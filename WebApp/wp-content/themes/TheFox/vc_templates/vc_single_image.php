...
$img_output =   '<span class="vc_box_shadow_3d_wrap">' . $img['thumbnail'] . '</span>';

}
elseif( $style !== 'vc_box_shadow_3d' && ($hover_effect == 'img_zoom_effect' || $hover_effect == 'img_play_effect' )) {
...
$output .= "\n\t" . '<div class="' . $css_class . ' '.$animation.' '.$hover_effect.'">';
$output .= "\n\t\t" . '<div class="wpb_wrapper">';
if($hover_effect == 'img_hover_title'){
$output .=	'<span>';
}
if(! empty( $link_to ) && $hover_effect == 'img_hover_title'){
$output .=	'<a' . $a_class . ' href="' . $link_to . '"' . ' target="' . $img_link_target . '"'. '>';
}
