...
//set variable
	...
	$center_logo = ($rd_data['rd_logo_width'])/2;
	$center_logo_m = ($rd_data['rd_logo_width']+60)/2;
	$output .= '#logo_img img{max-width:'.$logo_width.'px;}.cl_before_logo{margin-right:'.$center_logo_m.'px;}.cl_after_logo{margin-left:'.$center_logo_m.'px;}.nav_type_9_c #logo_img, .nav_type_9_c .logo_text{margin-left:-'.$center_logo.'px;}.nav_type_9_c #logo_img,.nav_type_9_c .logo_text{min-width:'.$logo_width.'px;}';
...
// Nav_type_9 ( center ) setting
	$output .='.nav_type_9_c nav ul,.nav_type_9_c .header_current_cart{background:'.$nav_bg.';}';
	$output .='.nav_type_9_c ul li a{color:'.$nav_text.'; border-top:5px solid rgba(0,0,0,0);}';
	$output .='.nav_type_9_c a#searchtop_img{color:'.$nav_text.';}';
	$output .='.nav_type_9_c nav ul li a:hover,.nav_type_9_c > ul > .current-menu-item > a{color:'.$nav_current_text.'; border-top:5px solid '.$nav_current_text.' !important;}';	
	$output .='.nav_type_9_c .header_current_cart,.nav_type_9_c #searchtop{display:none !important;}';
...
// Nav_type_19 / 20 setting
	...
	$output .='.transparent_header.opaque_header nav > ul > li > a:hover{color:'.$nav_current_text.' !important;}';
...
//Set variables
	...
	$output .= '.page_title_ctn{border-bottom:1px solid '.$title_border_color.';  }';
...
/*-----------------------------------------------------------------------------------*/
	...
	$output .= '.woocommerce-checkout input[type=text],.woocommerce-checkout input[type=email],.woocommerce-checkout input[type=password],.woocommerce-checkout textarea,.form-row .chosen-container-single .chosen-single,.woocommerce-checkout .product-name img,.order_and_total_wrapper,.user_current_cart,.woocommerce-page table.cart img,.woocommerce-message, .woocommerce-error, .woocommerce-info,.country_to_state,.shop_table.order_details,.woocommerce .order_details, .woocommerce-page .order_details,#calc_shipping_state,.woocommerce-cart #coupon_code,.woocommerce form .form-row input.input-text,.country_to_state .select2-choice,.state_select .select2-choice,#calc_shipping_state .select2-choice,.select2-drop-active,#braintree-cc-exp-month, #braintree-cc-exp-year{border:1px solid '.$mc_border_color.'; color: '.$mc_text_color.';}';
